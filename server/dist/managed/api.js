...
import { isBillingEnabled, createCheckoutSession, handleWebhook } from "./billing.js";
...
async function handleCreateTask(body, apiKey) {
    ...
    runAgentLoop({
        ...
        url,
        context,
        executeTool: (toolName, toolInput) => executeToolViaRelay(toolName, toolInput, browser_session_id),
        onStep: (step) => {
